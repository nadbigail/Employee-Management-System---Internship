...
function Login() {
  ...
  const submitForm = (e) => {
    ...
    const validUsers = {
      "admin@example.com": { password: "password", role: "admin", name: "Admin User", department: "System", token: "adminToken" },
      "nadine@example.com": { password: "password", role: "employee", name: "Nadine Abigail", department: "Finance Accounting & Tax", token: "nadineToken" },
      "sara@example.com": { password: "password", role: "employee", name: "Sara Nadya", department: "Marketing & Sales", token: "saraToken" },
      "eunike@example.com": { password: "password", role: "employee", name: "Eunike Alfrita Maharani", department: "Human Resources & General Affair", token: "eunikeToken" }
    };
    ...
    setLoading(true)
    setTimeout(() => {
      dispatch(setUser({ token: user.token, role: user.role, name: user.name, department: user.department }));
